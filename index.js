      ...
      if (story) {
        ...
        if (currentUser) {
          ...
          const progress = Math.min(
            100,
            (parseInt(storiesRead.textContent) / 5) * 100
          );
          document.getElementById(
            "readingProgress"
...
function updateAuthUI() {
  if (currentUser) {
    ...
    authNavItem.innerHTML = `
      <div class="user-nav">
        ...
        <div class="profile">
          <div class="user-avatar">${currentUser.name.charAt(0)}</div>
          <div class="dropdown">
            <button class="saved-btn" id="savedStoriesBtn">Saved Stories</button>
    ...
    document
      .getElementById("savedStoriesBtn")
      .addEventListener("click", function () {
        alert("Show saved stories here!");
        // Yahan aap apna modal ya page open karwa sakte ho
      });
